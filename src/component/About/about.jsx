...
function Detail() {
  ...
  return (
    <div id='About_section'>
      <div className="about" >
        <div className="image">
        < AccountBalanceIcon style={{ fontSize: '400px', color: 'wheat', marginTop:'4rem', marginLeft:'3rem' }} className='iconn' />
        </div>
        <div className="text">
            <h1 className='about_title'>Bunna Bank</h1>
            {/*  */}
            {/* <div
        ...
        {/*  */}
            <p className='about_p'>At Bunna, we understand that life can bring unexpected financial challenges. Whether you're looking to consolidate debt, finance a major purchase, or cover unexpected expenses, we're here to help.
